// Complete deployed contract ABIs for Mantle Sepolia
export const DEPLOYED_ABIS = {
  ComplianceRegistry: [
    {
      "inputs": [],
    ...
    },
    {
      ...
      "inputs": [
        ...
        {
          "indexed": false,
          "internalType": "enum ComplianceRegistry.VerificationLevel",
          "name": "level",
          "type": "uint8"
        },
        {
    ...
    {
      "inputs": [],
      "name": "verifiedAddressesMerkleRoot",
      "outputs": [
        {
          "internalType": "bytes32",
          "name": "",
  ...
  // Placeholder contracts (to be updated with real ABIs when deployed)
  LendingProtocol: [
    {
      "inputs": [],
      "name": "initialized",
